#############################################################################
# Makefile for building: SuperImpose_Calculate_Overlaps
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mo. Okt 2 13:11:10 2017
# Project:  SuperImpose_Calculate_Overlaps.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile SuperImpose_Calculate_Overlaps.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)   -L/home/oliver/Programs/Cplusplus/SuperImpose_Calculate_Overlaps/../../gems/gmml/bin/ -lgmml -pthread -lpthread -Wl,--no-as-needed 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		SuperImpose_Calculate_Overlaps.pro
QMAKE_TARGET  = SuperImpose_Calculate_Overlaps
DESTDIR       = 
...
Makefile: SuperImpose_Calculate_Overlaps.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
		...
		/usr/share/qt4/mkspecs/features/lex.prf \
		/usr/share/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -o Makefile SuperImpose_Calculate_Overlaps.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/SuperImpose_Calculate_Overlaps1.0.0 || $(MKDIR) .tmp/SuperImpose_Calculate_Overlaps1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/SuperImpose_Calculate_Overlaps1.0.0/ && (cd `dirname .tmp/SuperImpose_Calculate_Overlaps1.0.0` && $(TAR) SuperImpose_Calculate_Overlaps1.0.0.tar SuperImpose_Calculate_Overlaps1.0.0 && $(COMPRESS) SuperImpose_Calculate_Overlaps1.0.0.tar) && $(MOVE) `dirname .tmp/SuperImpose_Calculate_Overlaps1.0.0`/SuperImpose_Calculate_Overlaps1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/SuperImpose_Calculate_Overlaps1.0.0
...
residue_name_conversion_map.o: residue_name_conversion_map.cpp residue_name_conversion_map.h \
		io.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o residue_name_conversion_map.o residue_name_conversion_map.cpp
